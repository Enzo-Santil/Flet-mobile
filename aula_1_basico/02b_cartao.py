...
def main(page: ft.Page):
    ...
    page.add(
        ...
        ft.Container(
            ...
            bgcolor="#DF0505",  # cor de fundo do cartão (azul um pouco mais claro que o fundo)
            ...
            content=ft.Column(  # organiza os itens verticalmente, um abaixo do outro
                ...
                controls=[
                    ...
                    ft.Text("Zuzao Santil", size=22, weight=ft.FontWeight.BOLD, color="#F8E300"),

                    # Cargo/função, em azul claro suave para dar menos destaque
                    ft.Text("Engenheiro de Dados", color="#F8E300"),
                    ...
                    ft.Row(
                        ...
                        controls=[
                            ...
                            ft.Text("enzo@gmail.com", color="#FFFFFF"),
                        ],
                    ),
